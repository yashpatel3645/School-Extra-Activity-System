                ...
                <nav class="navbar navbar-static-top navbar-fixed-top">
                    <div class="container-fluid">
                        ...
                        <div class="topnav dropdown-menu-right float-xs-right">
                            <div class="btn-group">
                                <div class="user-settings no-bg">
                                    ...
                                    %>
                                    <a href="activity_cart.jsp"><b><label style="position: absolute; left: 8px"><%=cartno%></label></b>
                                    ...
                                    <label style="color: white !important;font-family: sans-serif;margin-top: 10px; font-size: 13px;"><a href="logout.jsp" 
                                                 style="color: white;display: <%=display%>">Logout</a></label>
                                    &nbsp;&nbsp;&nbsp;
                                    <button type="button" id="aria" class="btn btn-default no-bg micheal_btn" data-toggle="<%=toggle%>" data-target="<%=target%>" aria-expanded="false">
                                        <img src="admin/img/admin.png" class="admin_img2 rounded-circle avatar-img" alt="avatar"> <strong><%=login%></strong>
                        ...
                        <div class="collapse navbar-toggleable-sm col-lg-6 hidden-md-down float-xl-right  top_menu"
                             id="nav-content" style="right: <%=margin%>">
