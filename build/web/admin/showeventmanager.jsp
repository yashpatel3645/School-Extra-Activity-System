                    ...
                    <div class="col-xs-12 data_tables">
                        <div class="card m-t-35" style="margin-top: 54px; margin-bottom: 12px">
                            <div class="card-header bg-white">
                                <i class="fa fa-table"></i> Event Managers
                                <div>
                                    <form action="../control" method="post">
                                        <input type="hidden" name="function" value="manaregi">
                                        <button class="btn btn-primary" style="float: right;background-color: #4d4d4d;
                                                border-color: #4d4d4d;"><i class="fa fa-plus" aria-hidden="true"></i> Add Event Manager</button>
                                    </form>
                                </div>
                            </div>
                            <div class="card-block p-t-10">
                                <div class=" m-t-25">
                                    <table class="table table-striped table-bordered table-hover " id="sample_1">
                                        ...
                                        <%
                                            ResultSet rs = connection.geteventmanager(1);
                                            int i = 1;
                                            while (rs.next()) {
                                        %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="../control" method="post">
                                                    <input type="hidden" name="function" value="deactivemanager">
                                                    <input type="hidden" name="deactiveid" value="<%=rs.getString("email")%>">
                        ...
                        <div class="card m-t-35" style="margin-top: 54px;; margin-bottom: 12px">
                            <div class="card-header bg-white">
                                <i class="fa fa-table"></i> De-activated Event Manager
                            </div>
                            <div class="card-block p-t-10">
                                <div class=" m-t-25">
                                    <table class="table table-striped table-bordered table-hover" id="sample_6">
                                        ...
                                        <%
                                            rs = connection.geteventmanager(0);
                                            int j = 1;
                                            while (rs.next()) {
                                        %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="../control" method="post">
                                                    <input type="hidden" name="function" value="activemanager">
                                                    <input type="hidden" name="activeid" value="<%=rs.getString("email")%>">
