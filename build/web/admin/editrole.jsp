    ...
    %>
        ...
        %>
         <div id="content" class="bg-container fixed_header_menu_conainer fixed_header_menu_page" style="background-color: white;margin-left: 50px !important">
            ...
            <input type="hidden" name="editvalue" value="<%=rs.getInt("role_id")%>">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-3">
                    <input type="text" id="required2" name="Name" class="form-control" value="<%=rs.getString("name")%>" required>
                </div>
            </div>
                <%
                }catch(Exception e){
out.print(e);
            ...
            <div class="form-group row">
                <div class="col-xl-3 text-xl-right">
                                                    <label for="required2" class="form-control-label">Type *</label>
                                                </div>
                                                <div class="col-xl-3">
                                                    <select name="type" id="required2" class="validate[required] form-control select2 form-control" required>
