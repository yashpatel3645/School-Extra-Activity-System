...
<html>
    ...
    <body>
        ...
        <div id="content" class="bg-container fixed_header_menu_conainer fixed_header_menu_page">
            <a href="add_student.jsp"><button class="btn btn-success" style="margin-top: 47px;float:right;margin-right: 15px;">Add New Student</button></a>
        </div>
        <div id="content" class="bg-container fixed_header_menu_conainer fixed_header_menu_page">
                            ...
                            <div class="card-block p-t-10">
                                <div class=" m-t-25">
                                    <table class="table table-striped table-bordered table-hover " id="sample_1">
                                        ...
                                        <%
                                            ResultSet rs = connection.getuser(1);
                                            int i = 1;
                                            while (rs.next()) {
                                        %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="../control" method="post">
                                                    <input type="hidden" name="function" value="deactiveuser">
                                ...
                                <div class=" m-t-25">
                                    <table class="table table-striped table-bordered table-hover" id="sample_6">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="../control" method="post">
                                                    <input type="hidden" name="function" value="activeuser">
