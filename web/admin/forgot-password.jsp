            ...
            <div class="col-lg-8 push-lg-2 col-sm-10 push-sm-1">
                <div class="row">
                    <div class="col-lg-6 push-lg-3 col-md-8 push-md-2 col-sm-10 push-sm-1 forgotpwd_margin">
                        ...
                        <form action="../control" id="login_validator1" method="post"
                            class="form-group  login_validator">
                            <input type="hidden" name="function" value="forgot">
                            <div class="bg-white login_content login_border_radius">
                                ...
                                <div class="form-group form-actions">
                                    <button type="submit" class="btn btn-primary submit_email login_button" style="background-color: #4d4b4b !important" onclick="window.location.href='login.html'">
                                        Submit
                                    </button>
                                </div>
                            </div>
